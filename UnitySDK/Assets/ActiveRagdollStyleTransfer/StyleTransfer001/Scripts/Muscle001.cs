...
[System.Serializable]
public class Muscle001
{
    public string Name;
    public MuscleGroup001 Group;
    ...
    public void Init()
    {
        switch (this.Group)
        {
            case MuscleGroup001.Head:
                 MaximumForce = new Vector3(20,20,20);
                 break;
            case MuscleGroup001.Spine:
                 MaximumForce = new Vector3(40,40,40);
                 break;
            case MuscleGroup001.Hips:
                 MaximumForce = new Vector3(40,40,40);
                 break;
            case MuscleGroup001.Shoulder:
                 MaximumForce = new Vector3(40,20,20);
                 break;
            case MuscleGroup001.Elbow:
                 MaximumForce = new Vector3(40,20,20);
                 break;
            case MuscleGroup001.Hand:
                 MaximumForce = new Vector3(20,20,20);
                 break;
            case MuscleGroup001.LegUpper:
                 MaximumForce = new Vector3(120,40,40);
                 break;
            case MuscleGroup001.LegLower:
                 MaximumForce = new Vector3(80,40,40);
                 break;
            case MuscleGroup001.Foot:
                 MaximumForce = new Vector3(20,20,20);
                 break;
            default:
        ...
        if (!_hasRanVeryFirstInit) {
            ...
            RootConfigurableJoint = ConfigurableJoint;
            while (true){
                if (RootConfigurableJoint.connectedBody == null)
                    break;
                RootConfigurableJoint = RootConfigurableJoint.connectedBody.GetComponent<ConfigurableJoint>();
            }
